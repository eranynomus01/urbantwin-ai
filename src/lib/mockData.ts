...
export const MOCK_EMERGENCIES: EmergencyReport[] = [
  {
    ...
    disaster_type: "Flood",
    description: "Yamuna river water overflowing rapidly into Sector 4 residential colony. 45 citizens stranded on rooftop.",
    lat: 28.6100,
    lng: 77.2900,
    location_name: "Yamuna Bank Sector 4",
    people_affected: 45,
    urgency: "Critical",
    ai_severity: 9,
  ...
  {
    id: 102,
    user_name: "Anita Gupta",
    disaster_type: "Fire",
    description: "Transformer explosion caused major blaze in textile market area. Thick black smoke filling streets.",
    lat: 28.6500,
    lng: 77.2300,
